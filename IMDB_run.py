    ...
    for l in range(5):
        ...
        if adaptive_lr == 'False':
            ...
            optimizer = torch.optim.Adam([{'params': model.linear1.parameters()},
                                          ...
                                          {'params': model.NodeAggregation.parameters(), "lr": 0.002, "weight_decay": 1e-4},
                                          {'params': model.SimilarAttention.parameters(), "lr": 0.01, "weight_decay": 1e-4},
